...
public class MainMenu extends Activity {
	...
	final String[] m_disconnectedButtons = {"Show Log", "Connect", "Exit"};
	final String[] m_lobbyButtons = {"Show log", "Create game", "Exit"};
	final String[] m_gameButtons = {"Play game", "Send event", "Send room properties", "Send player properties", "Leave room", "Show Stats", "Exit"};
	...
	final OnItemClickListener m_disconnectedClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
            ...
            case 1:
                // Added code for connection/disconnection testing
                ApplicationManager.getClient().connectToMaster("8a6780d9-92bc-48f4-84f3-8bbdcd301300", "1.0", "Benjovi");
...
//								if (edit.getText().length() > 0)
                                    {
                                        ...
                                        //ApplicationManager.pushActivity(new Intent(ApplicationManager.getCurrentActivityContext(), GameActivity.class));
                                    }
                                }
                            });
